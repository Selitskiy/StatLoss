classdef KgVNet < BaseNetV & MLPInputNetV
    ...
    methods
        function net = KgVNet(m_in, n_out, mb_size, ini_rate, max_epoch)
    ...
    aLayers = [
        fullyConnectedLayer(net.m_ine,'Name','fcSig')
    ...
    dLayers = [
        fullyConnectedLayer(net.m_ine,'Name','fcTanh')
    ...
    nLayers = [
        fullyConnectedLayer(net.m_ine,'Name','fcNorm')
