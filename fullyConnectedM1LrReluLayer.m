classdef fullyConnectedM1LrReluLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = fullyConnectedM1LrReluLayer(name, numInChannels, numLabelChannels, numOutChannels, slope)
            ...
            if slope == 0
                layer.A = rand([layer.numOutChannels 1]);
            else
                layer.A = ones([layer.numOutChannels 1]) * slope;
            end
