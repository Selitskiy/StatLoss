classdef fullyConnectedM1GeluLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = fullyConnectedM1GeluLayer(name, numInChannels, numLabelChannels, numOutChannels)
        ...
        function [Z] = predict(layer, X)
            ...
            Z = gelu(layer.W * X(1:layer.numInChannels - layer.numLabelChannels, :) + layer.W0);
