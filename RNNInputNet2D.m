classdef RNNInputNet2D < MLPInputNet2D
    ...
    methods
        ...
        function [net, Xl, Yl, Bli, Blo, Sx, Sy, k_lob] = TrainTensors(net, M, l_sess, n_sess, norm_fli, norm_flo)
            [Xl, Yl, Bli, Blo, Sx, Sy, k_lob] = generic_train_seq_tensors2D(M, net.x_in, net.t_in, net.y_out, net.t_out, l_sess, n_sess, norm_fli, norm_flo);
            net.k_lob = k_lob;
        ...
        function [X2, Y2c, Yh2, Yhs2, Bti, Bto, Sx2, Sy2, k_tob] = TestTensors(net, M, l_sess, l_test, t_sess, sess_off, offset, norm_fli, norm_flo, Bi, Bo, k_tob)
            [X2, Y2s, Y2, Yh2, Yhs2, Bti, Bto, Sx2, Sy2, k_tob] = generic_test_seq_tensors2D(M, net.x_in, net.t_in, net.y_out, net.t_out, l_sess, l_test, t_sess, sess_off, offset, norm_fli, norm_flo, Bi, Bo, net.k_lob, k_tob);
