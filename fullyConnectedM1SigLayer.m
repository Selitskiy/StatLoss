classdef fullyConnectedM1SigLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = fullyConnectedM1SigLayer(name, numInChannels, numLabelChannels, numOutChannels)
        ...
        function [Z] = predict(layer, X)
            ...
            Z = sigmoid(layer.W * X(1:layer.numInChannels - layer.numLabelChannels, :) + layer.W0);
