classdef fullyConnectedM1TanhLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = fullyConnectedM1TanhLayer(name, numInChannels, numLabelChannels, numOutChannels)
        ...
        function [Z] = predict(layer, X)
            ...
            Z = tanh(layer.W * X(1:layer.numInChannels - layer.numLabelChannels, :) + layer.W0);
