classdef dotProdLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = dotProdLayer(name, numInChannels)
            ...
            layer.Description = "DotProd" + numInChannels + " channels";

            layer.numInChannels = numInChannels;

            layer.O = ones(numInChannels);
        ...
        function [Z] = predict(layer, X)
            ...
            Z = layer.O * (X(1:layer.numInChannels, :) .* X(layer.numInChannels+1:end, :));
